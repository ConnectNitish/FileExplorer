...
void MultipleSearchDirectory(char *spath , char *tardir ,char *currentWorkingDir);
void functionforCopy( char *filename, char *dirname , char * to_append,char *currentWorkingDir);
void functionforCopyforMultipleFile( char *filename, char *dirname , char * to_append,char *currentWorkingDir);
